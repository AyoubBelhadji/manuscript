...
%\pagestyle{empty}
    ...
    \hbox{ % Horizontal box
        ...
        {\begin{center}
        	...
        	{\noindent\large \emph{Échantillonnage des sous-espaces à l'aide des processus ponctuels déterminantaux}}\\[1\baselineskip]
        \end{center}}
        ...
        \vspace{2em}
         ...
         \begin{center}
             \includegraphics[height=1.3cm]{img/logo/logo_Centrale_Lille.png}\hspace{1em}
             \includegraphics[height=1.3cm]{img/logo/logo_Univ_Lille.png}\hspace{1em}
             \includegraphics[height=1.3cm]{img/logo/logo_Cristal.png}\hspace{1em}
             \includegraphics[height=1.3cm]{img/logo/logo-cnrs.pdf}\hspace{1em}
