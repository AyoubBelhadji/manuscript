...
Compared to the multiplicative symmetrization, the additive symmetrization gives an upper bound $..$...


allows convenient algebraic manipulations such as this result.



In this section, we prove a better majorization that is based on an averaged additive symmetrization:
...
\paragraph{Proof of Proposition~\ref{lemma:sharp_additive_symmetrization}}
