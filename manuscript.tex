...
When dealing with such approximation problems, the main concern would be the numerical implementation and the theoretical guarantees of such an algorithm. In particular, algorithms that are optimal in some sense are sought ...
