...
We started this manuscript by questioning the optimality of volume sampling for column subset selection problem and the potential improvement of the existing results. This question was the motive to adopt a new interpretation of determinantal point processes: they define naturally random subspaces that tend to be close to some reference subspace. 


\section{Perspectives}


\subsection{Exploring new kernels}
