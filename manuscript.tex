...
\end{equation}
where high probability, whenever $N \geq C d_{\eff}(\lambda) \log d_{\eff}(\lambda)$, with $d_{\eff}(\lambda)$ is the effective degree of freedom defined by
\begin{equation}
...
\Prb(S = I) \propto \Det \bm{X}_{I}^{\Tran} \bm{X}_{I} \mathbb{1}_{|I| = c}.
\end{equation} 
