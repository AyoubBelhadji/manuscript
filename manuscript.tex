...
By generalizing the argument of Jacobi, Christoffel proved that the existence of a unique configuration of nodes $\bm{x}_{GC}$ and weights $w_{n}$ such that $\displaystyle \sum\limits_{n \in [N]} w_{n} f(x_{n})$ coincides with $\displaystyle  \int_{a}^{b} f(t) \mathrm{d}\omega(t)$ for every polynomial of degree $2N-1$. 
