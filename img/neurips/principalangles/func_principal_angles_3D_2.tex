...
\node[canvas is plane={O(0,2,0)x(0,1,0)y(2.2/2.41,2+1/2.41,0)}] at (0.8,-0.6,0.1) {\includegraphics[width=2.4cm, height=2.7cm]{img/principalangles/signal_reconstruction_principle_2.pdf}};
...
\begin{scope}
	...
	\draw (2.7,3,0) node[below right=0.5mm] {$\tilde{\mathcal{T}}(\bm{x}) = \Span \tilde{k}(x_{i},.)_{i \in [N]}$};
    \clip (C) -- (A) -- (B) -- cycle;
